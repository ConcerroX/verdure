...
public class VerdureFeatures {
    ...
    public static final RegistryObject<DitheredDiskFeature> DITHERED_DISK = FEATURES.register(
    ...
    public static final RegistryObject<MushroomShelfFeature> MUSHROOM_SHELF = FEATURES.register(
        "mushroom_shelf", () -> new MushroomShelfFeature(NoneFeatureConfiguration.CODEC));

    public static final RegistryObject<UndergroundMushroomShelfFeature> UNDERGROUND_MUSHROOM_SHELF = FEATURES.register(
