...
public class VerdureBlocks {
    ...
    public static final DeferredBlock<Block> PEBBLES = registerBlock(
        "pebbles",
        () -> new PebblesBlock(BlockBehaviour.Properties.of().noOcclusion().sound(SoundType.STONE).instabreak()
            .noCollission())
    );
    public static final DeferredBlock<Block> ROCK = registerBlock(
        "rock",
        () -> new RockBlock(BlockBehaviour.Properties.of().noOcclusion().sound(SoundType.STONE).instabreak()
            .noCollission())
    );
    public static final DeferredBlock<CloverBlock> CLOVER = registerBlock(
        "clover",
        () -> new CloverBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TALL_GRASS))
    );
    ...
    public static final DeferredBlock<Block> BROWN_MUSHROOM_SHELF = BLOCKS.register(
        ...
        () -> new MushroomShelfBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).noCollission()
            .instabreak().sound(SoundType.GRASS).lightLevel((state) -> 1))
    );
    public static final DeferredBlock<Block> RED_MUSHROOM_SHELF = BLOCKS.register(
        "red_mushroom_shelf",
        () -> new MushroomShelfBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).noCollission()
            .instabreak().sound(SoundType.GRASS))
    );
    public static final DeferredBlock<Block> DAISIES = registerBlock(
        "daisies",
        () -> new DaisiesBlock(BlockBehaviour.Properties.of().noCollission().instabreak().sound(SoundType.GRASS))
    );
    public static final DeferredBlock<Block> BLUE_DAISIES = registerBlock(
        "blue_daisies",
        () -> new DaisiesBlock(BlockBehaviour.Properties.ofFullCopy(DAISIES.get()))
    );
    ...
    public static final DeferredBlock<Block> DRIED_MUD = registerBlock(
        "dried_mud",
        () -> new DriedMudBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DIRT).strength(0.8F)
            .sound(SoundType.GRAVEL))
    );
    public static final DeferredBlock<Block> HOLLOW_LOG = registerBlock(
        "hollow_log",
        () -> new HollowLogBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG).mapColor(MapColor.WOOD)
            .strength(2.0F).sound(SoundType.WOOD))
    );
    public static final DeferredBlock<Block> HANGING_MOSS = registerBlock(
        "hanging_moss",
        () -> new HangingMossBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).noCollission()
            .instabreak().offsetType(BlockBehaviour.OffsetType.XZ).sound(SoundType.MOSS))
    );
    public static final DeferredBlock<Block> TALL_HANGING_MOSS = BLOCKS.register(
        "tall_hanging_moss",
        () -> new TallHangingMossBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).noCollission()
            .instabreak().offsetType(BlockBehaviour.OffsetType.XZ).sound(SoundType.MOSS))
    );
    public static final DeferredBlock<Block> HUMUS = registerBlock(
        "humus",
        () -> new SnowyDirtBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DIRT).mapColor(MapColor.DIRT)
            .strength(0.5F).sound(SoundType.GRAVEL))
    );
    public static final DeferredBlock<Block> FALLEN_OAK_LEAVES = registerBlock(
        "fallen_oak_leaves",
        () -> new FallenLeavesBlock(BlockBehaviour.Properties.of().instabreak().sound(SoundType.GRASS).noOcclusion())
    );
    ...
    public static final DeferredBlock<Block> OAK_BRANCH = registerBlock(
        "oak_branch", () -> new BranchBlock(
            ...
            BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).noCollission().noOcclusion().strength(1.0F)
